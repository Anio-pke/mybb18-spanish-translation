...
$l['edit_post'] = "Editar este mensaje";
$l['delete_post'] = "Eliminar mensaje";
$l['delete_q'] = "¿Borrar?";
$l['delete_1'] = "Para borrar este mensaje, selecciona el cuadrito de la izquierda y luego haz clic en el botón de la derecha.";
$l['delete_2'] = "<b>Nota:</b> Si este mensaje es el primero de este tema al eliminarlo desaparecerá todo el tema.";
$l['subject'] = "Título";
...
$l['update_post'] = "Actualizar mensaje";
$l['poll'] = "Encuesta:";
$l['poll_desc'] = "Opcionalmente puedes agregar una encuesta a este tema.";
$l['poll_check'] = "Quiero agregar una encuesta";
$l['num_options'] = "Número de opciones:";
$l['max_options'] = "(Máximo: {1})";
$l['delete_now'] = "Borrar ahora";
$l['edit_time_limit'] = "Lo sentimos, pero no puedes editar tu mensaje. Los administradores han dispuesto que los mensajes solo pueden ser editados después de {1} minutos de haberse enviado.";
...
$l['error_already_delete'] = "Lo sentimos, pero este mensaje está eliminado.";

$l['thread_deleted'] = "Tema borrado permanentemente";
