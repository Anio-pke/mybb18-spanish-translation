...
$l['postbit_edited'] = "Este mensaje fue modificado por última vez en: {1} por";
...
$l['attach_quota'] = "Actualmente utilizas <strong>{1}</strong> del uso permitido de archivos adjuntos ({2})";
