...
$l['name_contains_desc'] = "Busca adjuntos introduciendo por ejemplo .zip para buscar adjuntos con la extensión .zip.";
$l['type_contains'] = "El tipo de archivo contiene";
$l['forum_is'] = "El foro es";
$l['username_is'] = "El nombre de usuario es";
$l['poster_is'] = "El usuario es";
$l['poster_is_either'] = "Usuario o invitado";
$l['poster_is_user'] = "Solo usuarios";
$l['poster_is_guest'] = "Solo invitados";
$l['more_than'] = "Más de";
