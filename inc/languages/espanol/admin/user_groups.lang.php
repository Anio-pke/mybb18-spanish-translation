...
$l['can_invite_members'] = "¿Puede invitar miembros?";
$l['user'] = "Usuario";
...
$l['can_invite_group_members'] = "¿Puede invitar miembros al grupo?";
$l['can_invite_group_members_desc'] = "¿Puede este usuario invitar nuevos miembros para ingresar en este grupo?";
$l['make_user_member'] = "¿Puede hacerse miembro?";
$l['make_user_member_desc'] = "¿Puede este usuario añadirse como miembro de este grupo si no está en él?";
...
$l['copy_permissions_from'] = "Copiar permisos de&hellip;";
...
$l['member_list'] = "Sí, mostrar los usuarios de este grupo en la lista de miembros";
$l['forum_team'] = "Sí, mostrar este grupo en la página 'Equipo del foro'";
...
$l['invite_only'] = "Sí, los usuarios necesitan ser invitados para ingresar en este grupo<br /><small>Los usuarios deben ser capaces de unirse y salir libremente de este grupo para que esto tenga efecto.</small>";
...
$l['can_view_board_closed'] = "¿Puede  ver el foro cuando está cerrado?";
...
$l['mod_new_posts'] = "¿Moderar nuevos mensajes?";
$l['mod_new_threads'] = "¿Moderar nuevos temas?";
$l['mod_new_attachments'] = "¿Moderar nuevos archivos adjuntos?";
$l['mod_after_edit'] = "¿Moderar los mensajes antes de ser editados?";
$l['poll_options'] = "Encuestas";
$l['max_posts_per_day'] = "Máximos mensajes por día";
$l['max_posts_per_day_desc'] = "Número máximo de mensajes que puede enviar cada usuario al día. 0 para ilimitados.";
...
$l['can_be_reported'] = "¿Puede ser reportado (perfil, mensajes y reputación)?";
$l['can_be_invisible'] = "¿Puede este grupo ocultar su estado en línea?";
...
$l['can_change_website'] = "¿Puede cambiar su sitio web?";
...
$l['required_posts_desc'] = "Aquí puedes introducir el número mínimo de mensajes que un usuario debe tener antes de poder agregar una firma. Si estableces 0, los usuarios podrán agregar una firma con cualquier número de mensajes.";
...
$l['max_reputations_perthread_desc'] = "Cuando 'Permitir reputación de mensaje' está activa, puedes establecer el máximo de reputaciones que los usuarios de este grupo pueden dar a un mismo usuario, en el mismo tema, por día, en la caja de abajo. Para permitir reputaciones ilimitadas para un usuario, por tema, introduce 0.";
...
$l['warnings_per_day'] = "Máximas advertencias permitidas al día. Si se establece en 0, no hay límite";
...
$l['max_emails_per_day_desc'] = "Máximo número de emails que los usuarios pueden enviar usando las funciones 'Enviar email' y 'Enviar tema a un amigo'. Establece 0 para deshabilitar el límite.";
$l['email_flood_time'] = "Tiempo entre emails:";
$l['email_flood_time_desc'] = "Minutos que debe esperar un usuario antes de enviar un email si acaba de enviar uno. Establece 0 para deshabilitar la espera.";
$l['forum_post_options'] = "Foros y mensajes";
$l['user_options'] = "Usuarios";
$l['can_manage_announce'] = "¿Puede configurar anuncios?<br /><small>Por favor, tenga en cuenta que los moderadores del foro deben ser asignados a al menos un foro para configurar los anuncios.</small>";
$l['can_manage_mod_queue'] = "¿Puede administrar la cola de moderación?<br /><small>Por favor, tenga en cuenta que los moderadores del foro deben ser asignados a al menos un foro para administrar la cola de moderación.</small>";
$l['can_manage_reported_content'] = "¿Puede administrar los reportes?<br /><small>Por favor, tenga en cuenta que los moderadores del foro deben ser asignados a al menos un foro para administrar los reportes.</small>";
$l['can_view_mod_logs'] = "¿Puede ver el historial de moderación?<br /><small>Por favor, tenga en cuenta que los moderadores del foro deben ser asignados a al menos un foro para ver el historial de moderación.</small>";
$l['can_edit_profiles'] = "¿Puede editar perfiles?<br /><small>Por favor, tenga en cuenta que los moderadores no pueden editar los perfiles de los super moderadores o administradores, independientemente de este permiso.</small>";
$l['can_ban_users'] = "¿Puede suspender usuarios?<br /><small>Por favor, tenga en cuenta que los moderadores no pueden suspender a los super moderadores o administradores, independientemente de este permiso.</small>";
$l['can_view_warnlogs'] = "¿Puede ver el historial de advertencias?";
$l['can_use_ipsearch'] = "¿Puede usar la búsqueda de IPs?";
...
$l['error_cannot_have_both_types'] = "No puedes tener un grupo con moderación e invitación a la vez. Por favor, escoge uno u otro.";
