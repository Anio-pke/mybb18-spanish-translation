...
$l['error_ajax_unknown'] = "Ha ocurrido un error desconocido al buscar ajustes.";
...
$l['error_admin_email_settings_empty'] = '<div class="smalltext" style="font-weight: normal;">Por favor, revisa que el ajuste de <strong>email del administrador</strong> no puede estar vacío, y debe ser un email válido.</div>';
...
$l['success_settings_updated_minsearchword'] = '<div class="smalltext" style="font-weight: normal;">Por favor, revisa que el ajuste <strong>Longitud mínima para la búsqueda</strong> coincida cn la configuración de la base de datos.</div>';
...
$l['setting_recaptchapublickey'] = "Clave pública reCAPTCHA";
$l['setting_recaptchapublickey_desc'] = "Tu clave pública reCAPTCHA.";
$l['setting_captchaprivatekey'] = "Clave privada reCAPTCHA";
$l['setting_captchaprivatekey_desc'] = "Tu clave privada reCAPTCHA.";
$l['setting_recaptchascore'] = "Puntuación reCAPTCHA v3";
$l['setting_recaptchascore_desc'] = "Establece la puntuación por la que un usuario es rechazado por reCAPTCHA v3. 1.0 es un usuario genuino, 0.0 es un bot.";
$l['setting_hcaptchapublickey'] = "Clave pública hCaptcha";
$l['setting_hcaptchapublickey_desc'] = "Tu clave pública hCaptcha.";
$l['setting_hcaptchaprivatekey'] = "Clave privada hCaptcha";
$l['setting_hcaptchaprivatekey_desc'] = "Tu clave privada hCaptcha.";
$l['setting_hcaptchatheme'] = "Tema hCaptcha";
$l['setting_hcaptchatheme_desc'] = "Establece el color de hCaptcha.";
$l['setting_hcaptchatheme_light'] = "Claro";
$l['setting_hcaptchatheme_dark'] = "Oscuro";
$l['setting_hcaptchasize'] = "Tamaño hCaptcha";
$l['setting_hcaptchasize_desc'] = "Establece el tamaño de hCaptcha.";
$l['setting_hcaptchasize_normal'] = "Normal";
$l['setting_hcaptchasize_compact'] = "Compacto";
...
$l['setting_nocacheheaders_desc'] = "Con esta opción fuerzas que las páginas dinámicas sean revalidadas por los navegadores y que no sean almacenadas por los proxies.";
...
$l['setting_errortypemedium_desc'] = "Tipo de errores que se mostrarán con información detallada. Se recomienda ocultar errores y advertencias en un foro de producción y registrarlos en su lugar. ";
