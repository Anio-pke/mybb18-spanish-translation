...
$l['error_invalidannouncement'] = "El anuncio especificado no existe.";
...
$l['error_attachsize'] = "El archivo \"{1}\" es demasiado grande. El tamaño máximo para ese tipo de archivos es de {2} kilobytes.";
$l['error_uploadempty'] = "El archivo \"{1}\" está vacío.";
...
Hemos recibido una petición en {2} para cambiar tu dirección de email (ver detalles debajo).

Email Antiguo: {3}
Email Nuevo: {4}

Este cambio es automático. Si no has realizado esta petición, por favor, contacta con un Administrador.
...
Recibes este email porque tu o alguien con acceso a tu usuario, ha cambiado recientemente la contraseña de tu cuenta.

Nombre de usuario: {1}
Email: {2}

Si no has realizado este cambio, por favor, contacta con un Administrador.
...
Para ver, responder o reenviar este mensaje, ve al siguiente enlace:
...
{2} ha pedido unirse a {3} en {4} (ver abajo).

Razón: {5}

Para aceptar o denegar esta petición, debes ir a
